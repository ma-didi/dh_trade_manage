...
<head>
<title>陕西德泓贸易管理平台</title>
	<link rel="stylesheet" rev="stylesheet" type="text/css" href="${ctx}/skin/default/css/login.css" media="all" />
</head>

<body>
<form id="login_main" method="post" action="${pageContext.request.contextPath}/fac/fmain">
<div id="warpbox">
	<div class="main">
		 <div class="zck">
		  <div class="zc">
			...
			<div class="dl">
<%--				<button type="submit" value="登录" class="loginImgOut"></button>--%>
				<input  class="loginImgOut" value="" type="button"
						onclick="formSubmit('${ctx}/login/fmain','_self');"
