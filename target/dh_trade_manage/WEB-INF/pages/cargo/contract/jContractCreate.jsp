...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/contract/contractAndInsert','_self');this.blur();">确定</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="offeror" value="陕西德泓贸易有限公司"/></td>
	        </tr>
	        <tr>
