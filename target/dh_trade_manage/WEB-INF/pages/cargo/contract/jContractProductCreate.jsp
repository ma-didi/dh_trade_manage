...
<body>
<form method="post">
    <input type="text" name="contractId" value="${sessionScope.contractId}"/>
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#" onclick="formSubmit('${ctx}/productc/contractProductCAndAddTwo','_self');">确定</a></li>
            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><input type="text" name="loadinfRate"/></td>
                    ...
                    <table id="ec_table" class="tableRegion" width="98%">
                        ...
                        <c:forEach items="${dataList}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                                <td><input type="checkbox" name="contratProductId" value="${o.contratProductId}"/></td>
                                ...
                                <td>${o.amount}</td>
                                <td>
                                    <a href="${ctx}/productc/contractProductCAndDelete?contractProductId=${o.contratProductId}&contractId=${sessionScope.contractId}" title="删除货物">[删除]</a>
                                    <a href="${ctx}/productc/contractProductCAndUpdateOne?contractProductId=${o.contratProductId}" title="修改货物">[修改]</a>
                                    <a href="${ctx}/extCproduct/extCproductAndAddOne/${o.contratProductId}" title="附件">[附件]</a>
                                </td>
                            </tr>
                        </c:forEach>
